...
public static class TypeChart
{
    static float[][] chart =
    {
        ...
        /*Fire*/    new float[] {1f,   0.5f, .5f, 1f,   2f,   2f,   1f,   1f,   1f,   1f,   1f,   2f,   0.5f, 1f,   0.5f, 1f,   2f,   1f},
    ...
    public static float TypeEffectivness(Types attackType, Types defenseType)
    {
